# 04 — Timed Mode & Restart Controls

**What to build:** A new "Timed Mode" where users race against a countdown timer (15, 30, or 60 seconds), and quick-restart controls to rapidly try again or load a new passage without navigating menus.
